...
class Autocorrect{
    ...
    public:
        /**
         * CONSTRUTOR DA CLASSE Autocorrect.
         * CRIA UM OBJETO DO TIPO Autocorrect QUE RECEBE O TAMANHO DA PALAVRA OU PREFIXO DADO PELO USUÁRIO.
         * @param len_prefixo TAMANHO DA PALAVRA OU PREFIXO DADO PELO USUÁRIO.
         */
